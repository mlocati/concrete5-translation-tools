	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav loggedin-yes">
				...
				<li><a href="javacript:void(0)" target="_blank" id="transifex-resources-url" class="with-tooltip" data-toggle="tooltip" data-placement="bottom" title="Useful for setting&lt;br&gt;&lt;i&gt;Auto update resources&lt;/i&gt;">Transifex resources</a>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default pull-left" id="package-txview">View on Transifex</button>
